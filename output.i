...
#pragma GCC visibility push(default)
# 45 "/usr/include/c++/12/bits/specfun.h" 3
...
# 60 "/usr/include/c++/12/bits/stl_pair.h" 3
...
# 1839 "/usr/include/c++/12/type_traits" 3
  template<>
...
# 1969 "/usr/include/c++/12/type_traits" 3
  template<>
...
# 3704 "/usr/include/c++/12/type_traits" 3

}
# 61 "/usr/include/c++/12/bits/stl_pair.h" 2 3
...
# 67 "/usr/include/c++/12/bits/stl_iterator.h" 3
...
# 1483 "/usr/include/c++/12/bits/stl_iterator.h" 3
    public:
...
# 46 "/usr/include/c++/12/bits/specfun.h" 2 3
...
# 47 "/usr/include/c++/12/bits/specfun.h" 2 3
...
# 1218 "/usr/include/c++/12/bits/specfun.h" 3
  inline float
  airy_aif(float __x)
  {
...
# 1294 "/usr/include/c++/12/bits/specfun.h" 3
  inline float
  conf_hypergf(float __a, float __c, float __x)
  { return std::__detail::__conf_hyperg<float>(__a, __c, __x); }
# 1305 "/usr/include/c++/12/bits/specfun.h" 3
  inline long double
...
# 1342 "/usr/include/c++/12/bits/specfun.h" 3
  inline float
  hypergf(float __a, float __b, float __c, float __x)
  { return std::__detail::__hyperg<float>(__a, __b, __c, __x); }
# 1353 "/usr/include/c++/12/bits/specfun.h" 3
  inline long double
...
int main() {
    ...
    Meta side_a_meta = {.name = "side_a", .offset = ({ size_t offset = current_offset; current_offset += (sizeof(double)); if (current_offset > 4096) { fprintf(
# 78 "main.cpp" 3 4
   stderr
# 78 "main.cpp"
   , "Memory overflow: not enough space!\n"); exit(1); } offset; }), .size = sizeof(double), .is_ready = 0};
    Meta side_b_meta = {.name = "side_b", .offset = ({ size_t offset = current_offset; current_offset += (sizeof(double)); if (current_offset > 4096) { fprintf(
# 79 "main.cpp" 3 4
   stderr
# 79 "main.cpp"
   , "Memory overflow: not enough space!\n"); exit(1); } offset; }), .size = sizeof(double), .is_ready = 0};
    Meta side_c_meta = {.name = "side_c", .offset = ({ size_t offset = current_offset; current_offset += (sizeof(double)); if (current_offset > 4096) { fprintf(
# 80 "main.cpp" 3 4
   stderr
# 80 "main.cpp"
   , "Memory overflow: not enough space!\n"); exit(1); } offset; }), .size = sizeof(double), .is_ready = 0};
    Meta perimeter_meta = {.name = "perimeter", .offset = ({ size_t offset = current_offset; current_offset += (sizeof(double)); if (current_offset > 4096) { fprintf(
# 81 "main.cpp" 3 4
   stderr
# 81 "main.cpp"
   , "Memory overflow: not enough space!\n"); exit(1); } offset; }), .size = sizeof(double), .is_ready = 0};
    Meta area_meta = {.name = "area", .offset = ({ size_t offset = current_offset; current_offset += (sizeof(double)); if (current_offset > 4096) { fprintf(
# 82 "main.cpp" 3 4
   stderr
# 82 "main.cpp"
   , "Memory overflow: not enough space!\n"); exit(1); } offset; }), .size = sizeof(double), .is_ready = 0};
    ...
    do { *((uint8_t*)shared_memory + side_a_meta.offset) = 3.0; side_a_meta.is_ready = 1; } while (0);
    do { *((uint8_t*)shared_memory + side_b_meta.offset) = 4.0; side_b_meta.is_ready = 1; } while (0);
    do { *((uint8_t*)shared_memory + side_c_meta.offset) = 5.0; side_c_meta.is_ready = 1; } while (0);


    if (side_a_meta.is_ready && side_b_meta.is_ready && side_c_meta.is_ready) {
        double a, b, c;
        do { if (!side_a_meta.is_ready) { exit(1); } *&a = *((uint8_t*)shared_memory + side_a_meta.offset); } while (0);
        do { if (!side_b_meta.is_ready) { exit(1); } *&b = *((uint8_t*)shared_memory + side_b_meta.offset); } while (0);
        do { if (!side_c_meta.is_ready) { exit(1); } *&c = *((uint8_t*)shared_memory + side_c_meta.offset); } while (0);
        printf("%f, %f, %f", a, b, c);

        double p = a + b + c;
        do { *((uint8_t*)shared_memory + perimeter_meta.offset) = p; perimeter_meta.is_ready = 1; } while (0);


        double s = p / 2.0;
        double area_value = std::sqrt(s * (s - a) * (s - b) * (s - c));
        do { *((uint8_t*)shared_memory + area_meta.offset) = area_value; area_meta.is_ready = 1; } while (0);
...
# 109 "main.cpp" 3 4
               stderr
# 109 "main.cpp"
                     , "Не все переменные готовы для вычислений.\n");
    }
